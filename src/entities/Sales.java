...
public class Sales {
    ...
    public Cliente getSales_cliente() {
        return sales_cliente;
    }

    public void setSales_cliente(Cliente sales_cliente) {
        this.sales_cliente = sales_cliente;
    }
